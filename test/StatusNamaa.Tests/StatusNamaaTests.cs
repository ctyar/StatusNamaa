...
public class StatusNamaaTests
{
    ...
    public async Task DefaultOptionTest()
    {
        var expected = """
            ...
            <text x="460px" y="132px" fill="#b0fd6a" text-anchor="end">25</text>
            </g>
            <g>
            <g clip-path="url(#clip1)"><text x="10px" y="156px" fill="#53b1fd">Lock Contentions</text></g>
            <text x="460px" y="156px" fill="#b0fd6a" text-anchor="end"></text>
            </g>
            </g>
            <text x="10px" y="180px" fill="#53b1fd" font-size="10px">Environment: <tspan fill="#b0fd6a">Production</tspan>  Version: <tspan fill="#b0fd6a">0.6.0-alpha.6+f50922c5e0</tspan></text>
            </svg>
            """;
    ...
    public async Task EmptyMetrics()
    {
        var expected = """
            ...
            <text x="10px" y="36px" fill="#bfc9d1" font-size="36px" font-weight="500">Status Namaa</text>
            <text x="10px" y="84px" fill="#53b1fd" font-size="10px">Environment: <tspan fill="#b0fd6a">Production</tspan>  Version: <tspan fill="#b0fd6a">0.6.0-alpha.6+f50922c5e0</tspan></text>
            </svg>
            """;
        var builder = WebApplication.CreateSlimBuilder();
        builder.WebHost.UseTestServer();
    ...
    public async Task MetricWithEmptyName()
    {
        var expected = """
            ...
            <text x="10px" y="108px" fill="#53b1fd" font-size="10px">Environment: <tspan fill="#b0fd6a">Production</tspan>  Version: <tspan fill="#b0fd6a">0.6.0-alpha.6+f50922c5e0</tspan></text>
            </svg>
            """;
        var builder = WebApplication.CreateSlimBuilder();
        builder.WebHost.UseTestServer();
